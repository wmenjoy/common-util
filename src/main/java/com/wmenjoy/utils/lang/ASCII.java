...
public abstract class ASCII {
    ...
    public static boolean isType(final int ch, final int type) {
    ...
    public static boolean isAlpha(final int ch) {
    ...
    public static boolean isAlnum(final int ch) {
        return isType(ch, ALNUM);
    }

    public static boolean isGraph(final int ch) {
        return isType(ch, GRAPH);
    }

    public static boolean isPrint(final int ch) {
        return ((ch - 0x20) | (0x7E - ch)) >= 0;
    }

    public static boolean isPunct(final int ch) {
    ...
    public static boolean isOctDigit(final int ch) {
        return ((ch - '0') | ('7' - ch)) >= 0;
    }

    public static boolean isCntrl(final int ch) {
        return isType(ch, CNTRL);
    }

    public static boolean isLower(final int ch) {
        return ((ch - 'a') | ('z' - ch)) >= 0;
    }

    public static boolean isUpper(final int ch) {
        return ((ch - 'A') | ('Z' - ch)) >= 0;
    }

    public static boolean isWord(final int ch) {
    ...
    public static int toLower(final int ch) {
        return isUpper(ch) ? (ch + 0x20) : ch;
    }

    public static int toUpper(final int ch) {
