...
public class EnumDef extends FieldDef {
    ...
    protected EnumDef(final Field field, final Class<?> clazz, final FieldDef alias)
    ...
    @Override
    public FieldRule<?> getFieldRule(final Field field, final Class<?> clazz) throws SystemConfigErrorException {
        ...
        return EnumRule.getEnumRule(type, clazz, nullable);
    }
