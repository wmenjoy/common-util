...
public class MethodInfo {
    ...
    private MethodInfo(ConstantPool cp) {
        ConstantPool = cp;
        attribute = null;
    }
     ...
     * @see Descriptor
     */
    public MethodInfo(ConstantPool cp, String methodname, String desc) {
        this(cp);
        accessFlags = 0;
        name = cp.addUtf8Info(methodname);
        cachedName = methodname;
        descriptor = ConstantPool.addUtf8Info(desc);
    }

    MethodInfo(ConstantPool cp, DataInputStream in) throws IOException {
        this(cp);
        read(in);
    }
     ...
     * @see Descriptor
     */
    public MethodInfo(ConstantPool cp, String methodname, MethodInfo src,
    ...
    public String getName() {
       if (cachedName == null)
           cachedName = ConstantPool.getUtf8Info(name);
    ...
    public void setName(String newName) {
        name = ConstantPool.addUtf8Info(newName);
        cachedName = newName;
    }
    ...
    public String getDescriptor() {
        return ConstantPool.getUtf8Info(descriptor);
    }
    ...
    private void read(MethodInfo src, String methodname, Map classnames)
            throws BadBytecode {
        ConstantPool destCp = ConstantPool;
        accessFlags = src.accessFlags;
        name = destCp.addUtf8Info(methodname);
        cachedName = methodname;
        ConstantPool srcCp = src.ConstantPool;
    ...
    private void read(DataInputStream in) throws IOException {
        ...
        attribute = new ArrayList();
        for (int i = 0; i < n; ++i)
            attribute.add(AttributeInfo.read(ConstantPool, in));
    }
